...
<div class="head">
        ...
        <h4>دفتر ارتباط با صنعت</h4>
    </div>
    <div class="body">
        <h5>به <span><?php echo($companyType); ?></span>: <span><?php echo($comName); ?></span></h5>
        <h5> از: دفتر ارتباط با صنعت دانشگاه آزاد اسلامی واحد شهرقدس</h5>
        ...
        <div>
            ...
            <p>در ضمن دانشجو لازم است برنامه حضور خود را بعد از تایید سرپرست کارآموزی حداکثر ظرف مدت یک هفته 
                ...
                طبق بخشنامه <?php echo(fa_number(47) .'/' . fa_number(140000)); ?> مورخ <?php echo(fa_number(1386) . '/' . fa_number(6) . '/' . fa_number(15)); ?> سازمان مرکزی می باشد. 
            </p>
        </div>
